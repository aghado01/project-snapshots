# Tree Manifest TOC for Snapshot: `tools_20260423_123303_s*.txt`

Strategy: FileLevel | MaxShardSpanBytes: 32768 | Created: 20260423_123303 | Shards: 3

Payload:
`./tools_20260423_123303_tree.md`
`./tools_20260423_123303_s001.txt` files:1
`./tools_20260423_123303_s002.txt` files:2
`./tools_20260423_123303_s003.txt` files:1
...
## Tree for `tools_20260423_123303_s*.txt`
```
file row metadata: name<TAB>shard_index<TAB>row_offset<TAB>row_meta_end<TAB>row_content_begin<TAB>row_content_end
tools
    claude-jso-jackson.ps1	s001	276	338	342	22216
    claude-jso-markdown.ps1	s002	138	201	205	19947
    jso-hash.ps1	s002	19951	20000	20004	25949
    jso-jackson.ps1	s003	138	193	197	32611
```
