# Tree Manifest TOC for Snapshot: `tools_20260424_134505_s*.txt`

Strategy: FileLevel | MaxShardSpanBytes: 32768 | Created: 20260424_134506 | Shards: 3

Payload:
`./tools_20260424_134505_tree.md`
`./tools_20260424_134505_s001.txt` files:1
`./tools_20260424_134505_s002.txt` files:2
`./tools_20260424_134505_s003.txt` files:1
...
## Tree for `tools_20260424_134505_s*.txt`
```
...
tools
    ...
    jso-jackson.ps1	s003	138	193	197	41543
```
