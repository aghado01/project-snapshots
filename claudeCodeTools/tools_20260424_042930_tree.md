# Tree Manifest TOC for Snapshot: `tools_20260424_042930_s*.txt`

Strategy: FileLevel | MaxShardSpanBytes: 32768 | Created: 20260424_042931 | Shards: 4

Payload:
`./tools_20260424_042930_tree.md`
`./tools_20260424_042930_s002.txt` files:1
`./tools_20260424_042930_s003.txt` files:2
`./tools_20260424_042930_s004.txt` files:1
...
## Tree for `tools_20260424_042930_s*.txt`

This snapshot came out a little wierd with an empty s001, which has been omitted because it was empty. bug ticket filed.

```
file row metadata: name<TAB>shard_index<TAB>row_offset<TAB>row_meta_end<TAB>row_content_begin<TAB>row_content_end
tools
    claude-jso-jackson.ps1	s002	138	200	204	45954
    claude-jso-markdown.ps1	s003	138	201	205	19947
    jso-hash.ps1	s003	19951	20000	20004	25949
    jso-jackson.ps1	s004	138	193	197	32611
```
